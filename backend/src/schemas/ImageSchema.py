...
class ImageMetadataSchema(Schema):
    ...
    syncStatus = fields.Enum(Status, by_value=True, required=True)  # "LOCAL_ONLY", <-- trqqq promenq bazata danni
    fileHash: str = fields.Str(required=True)

    # "hoursSpent": 0, <-- ne mi hareswa towa
    # "metadata": { "sizeBytes": 230886077, "mimeType": "image/clip"}, <-- tuj weche go ima w s3?
    # "deviceOrigin": "23e49f21-4e6c-409b-8e1e-ca9e55127ea0", <-- nqma go w bazite danni
    createdAt = fields.DateTime() # "2026-04-16T19:56:15.872Z",
    updatedAt = fields.DateTime() #: "2026-05-14T16:39:50.000Z",
    # "accessedAt": "2026-06-03T19:39:07.369Z", <-- възможно е колкото да си намеря приятелка

    # "thumbnailPath": "thumbnails/thumb_dobribobri.clip.png", <- actually ne ni trqbwa 
